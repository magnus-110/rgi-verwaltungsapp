...
CREATE OR REPLACE FUNCTION public.get_audit_templates_by_token(p_token text)
RETURNS SETOF json
...
GRANT EXECUTE ON FUNCTION public.get_audit_templates_by_token(text) TO anon, authenticated;