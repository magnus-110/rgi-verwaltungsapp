  ...
  public: {
    Tables: {
      ...
      billable_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "billable_events_assignment_id_fkey"
          ...
          },
          {
            ...
            columns: ["contract_id"]
            isOneToOne: false
            referencedRelation: "management_contract_summary"
          ...
          {
            foreignKeyName: "billable_events_rgi_invoice_item_id_fkey"
            columns: ["rgi_invoice_item_id"]
            isOneToOne: false
      ...
      management_contract_fees: {
        Row: {
          ...
          tier_to: number | null
          unit_kind: Database["public"]["Enums"]["rgi_fee_unit_kind"] | null
          updated_at: string
          valid_from: string | null
          valid_to: string | null
          vat_rate: number
      ...
      offer_questions: {
        Row: {
          ...
          is_active: boolean
          key: string
          kind: Database["public"]["Enums"]["rgi_offer_question_kind"]
          label: string
          options: Json | null
          position: number
        }
      ...
      offers: {
        ...
        Relationships: [
          {
            foreignKeyName: "offers_prospect_contact_id_fkey"
    ...
    Views: {
      management_contract_summary: {
        Row: {
          ...
          contract_id: string | null
          flat_monthly_net: number | null
          management_mode: Database["public"]["Enums"]["management_mode"] | null
          status: Database["public"]["Enums"]["rgi_contract_status"] | null
          units_apartment: number | null
          units_commercial: number | null
          units_other: number | null
          units_parking: number | null
    ...
    Enums: {
      ...
      rgi_contract_status: "draft" | "active" | "ended"
      rgi_fee_basis:
        | "unit_month"
        | "case"
        | "item_year"
        ...
        | "net_rent_percent"
        | "custom"
      rgi_fee_debtor: "community" | "owner" | "tenant"
      rgi_fee_unit_kind: "apartment" | "commercial" | "parking" | "other"
      ...
      rgi_invoice_status:
        ...
        | "overdue"
        | "cancelled"
      rgi_offer_question_kind: "text" | "number" | "boolean" | "choice"
      rgi_offer_status:
        | "inquiry"
        | "drafted"
        | "sent"
