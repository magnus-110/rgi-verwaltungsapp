...
export const SERVICE_PROVIDER_CATEGORIES: ServiceProviderCategory[] = [
  ...
  { id: "entruempelung", label: "Entrümpelung", group: "haus_aussen" },

  // Bau & Ausbau
  { id: "maler", label: "Maler", group: "bau_ausbau" },
  ...
  { id: "dachdecker", label: "Dachdecker", group: "bau_ausbau" },
  { id: "maurer", label: "Maurer", group: "bau_ausbau" },
  { id: "stuckateur", label: "Stuckateur", group: "bau_ausbau" },
  { id: "schreiner", label: "Schreiner / Tischler", group: "bau_ausbau" },
  ...
  // Sonstige
  { id: "versicherung", label: "Versicherung", group: "sonstige" },
