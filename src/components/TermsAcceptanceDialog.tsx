    ...
    <Dialog open={open} onOpenChange={() => {}}>
      ...
      >
            <DialogHeader>
              ...
              <DialogDescription>
                Bitte lesen und akzeptieren Sie die folgenden Dokumente, um die App nutzen zu können.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 pt-4 border-t">
              <div className="flex items-center space-x-2">
                ...
                <label htmlFor="agb" className="text-sm">
                  Ich habe die <strong>Allgemeinen Geschäftsbedingungen</strong> gelesen und akzeptiere diese.
                </label>
              </div>
              ...
              <Button 
                ...
                disabled={!agbAccepted || !datenschutzAccepted || isSubmitting}
                className="w-full"
              >
