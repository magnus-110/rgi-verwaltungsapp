                ...
                <CardContent className="p-3">
                  ...
                  {isActive && (
                    <div className="mt-3 border-t pt-3 space-y-1">
                      <p className="text-xs font-medium text-muted-foreground mb-2">Manuelle Stimmabgabe:</p>
                          ...
                          <div key={a.id} className="flex items-center justify-between py-1">
                            ...
                            <div className="flex gap-1">
                              <Button size="sm" variant="ghost" className="h-6 px-2 text-xs text-green-600"
                                onClick={() => castVoteMutation.mutate({ itemId: item.id, assignmentId: a.assignment_id, vote: "yes", meaWeight: meaW })}>
                                Ja
                              </Button>
                              <Button size="sm" variant="ghost" className="h-6 px-2 text-xs text-red-600"
                                onClick={() => castVoteMutation.mutate({ itemId: item.id, assignmentId: a.assignment_id, vote: "no", meaWeight: meaW })}>
                                Nein
                              </Button>
