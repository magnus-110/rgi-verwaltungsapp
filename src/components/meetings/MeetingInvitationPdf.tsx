...
<head>
  ...
  <style>
    ...
    body { font-family: 'Segoe UI', Arial, sans-serif; font-size: 11pt; line-height: 1.6; color: #4a4849; max-width: 170mm; margin: 0 auto; }
    .header { position: relative; padding-bottom: 16px; margin-bottom: 28px; border-bottom: 2px solid #ee7202; }
    .header-logo { position: absolute; top: 0; right: 0; height: 48px; }
    .header h1 { font-size: 17pt; margin: 0 0 4px; color: #4a4849; font-weight: 700; }
    .header p { margin: 2px 0; font-size: 10pt; color: #777; }
    .meta { margin-bottom: 24px; }
    .meta-row { display: flex; margin-bottom: 5px; }
    .meta-label { font-weight: 600; width: 120px; color: #4a4849; }
    .meta-value { color: #4a4849; }
    .greeting { margin-bottom: 20px; }
    h2 { font-size: 13pt; color: #4a4849; border-bottom: 1px solid #e5e7eb; padding-bottom: 6px; margin-top: 24px; }
    .agenda-item { margin-bottom: 14px; padding: 10px 12px; background: #faf8f5; border-radius: 6px; border-left: 3px solid #ee7202; }
    .agenda-item .top-number { font-weight: 700; color: #ee7202; font-size: 10pt; }
    .agenda-item .top-title { font-weight: 600; margin-left: 8px; color: #4a4849; }
    .agenda-item .top-desc { font-size: 10pt; color: #666; margin-top: 4px; }
    .footer { margin-top: 40px; padding-top: 16px; border-top: 1px solid #ee7202; font-size: 9pt; color: #999; text-align: center; }
  </style>
</head>
<body>
  <div class="header">
