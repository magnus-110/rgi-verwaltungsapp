...
export const CreateBuildingDialog = ({ onBuildingCreated }: CreateBuildingDialogProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Create the building with explicit building_code as empty string to satisfy TypeScript
      // The trigger will automatically set the correct building_code
      const { data: buildingData, error: buildingError } = await supabase
        ...
        .insert({
          ...
          type: formData.type,
          building_code: "" // Temporary value, will be overwritten by trigger
        })
        .select()
        .single();
