...
import { ArrowLeft, Plus, Save, Trash2, Phone, Mail, Landmark, Users, ChevronDown, ChevronRight, FileText, Wrench, CalendarIcon, CheckCircle2 } from "lucide-react";
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Möchten Sie {p.first_name || ""} {p.last_name || "diese Person"} wirklich löschen? Alle zugehörigen Kontaktdaten (Telefon, E-Mail, Bankverbindung) werden ebenfalls entfernt.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                                <AlertDialogCancel>Abbrechen</AlertDialogCancel>
                                <AlertDialogAction onClick={() => removePerson(p._localId)} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
                                  Löschen
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
